...
class DetailRekamMedisController extends Controller
{
    public function index($id) 
    {
        ...
        return view('dokter.rekam-medis.detail.index', compact('detailRekamMedis', 'id'));
    }
    public function create($id)
    {
        $kode_tindakan_terapi = \DB::table('kode_tindakan_terapi')->select('idkode_tindakan_terapi', 'deskripsi_tindakan_terapi')->get();
        return view('dokter.rekam-medis.detail.create', compact('kode_tindakan_terapi', 'id'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('dokter.rekam-medis.detail.index', [$request->idrekam_medis])
    ...
    protected function edit($id)
    {
       $kode_tindakan_terapi = \DB::table('kode_tindakan_terapi')->select('idkode_tindakan_terapi', 'deskripsi_tindakan_terapi')->get();
        ...
        return view('dokter.rekam-medis.detail.edit', compact('id', 'detail_rekam_medis', 'kode_tindakan_terapi'));
    }
