...
$breadcrumbs = [
    ...
    'Pemilik' => route('resepsionis.registrasi.pemilik.index'),
    'Edit' => null,
];
@endphp
        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('resepsionis.registrasi.pemilik.update') }}" method="POST">
                        @csrf
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="{{ route('resepsionis.registrasi.pemilik.index') }}" class="btn btn-secondary">
