...
$breadcrumbs = [
    ...
    'Pet' => route('resepsionis.registrasi.pet.index'),
    'Edit' => null,
];
@endphp
        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('resepsionis.registrasi.pet.update') }}" method="POST">
                        @csrf
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="{{ route('resepsionis.registrasi.pet.index') }}" class="btn btn-secondary">
