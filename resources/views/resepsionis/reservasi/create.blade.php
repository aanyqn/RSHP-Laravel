...
@php
    $breadcrumbs = [
        ...
        'Temu Dokter' => route('resepsionis.reservasi.index'),
        'Buat Reservasi' => null,
    ];
@endphp
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h4>Buat Reservasi Temu Dokter</h4>
                </div>
                <div class="card-body">
                    @if (session('error'))
                    ...
                    <form action="{{ route('resepsionis.reservasi.store') }}" method="POST">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="{{ route('resepsionis.reservasi.index') }}" class="btn btn-secondary">
