...
<div class="d-flex justify-content-between m-3 mt-0">
    ...
    <form action="{{ route('resepsionis.reservasi.create') }}" method="GET">
...
@endif
<div class="card m-3">
    <div class="card-header"><h3 class="card-title">Reservasi Temu Dokter</h3></div>
    <div class="card-body">
    <table class="table table-bordered">
        ...
        @foreach ($daftar_temu_dokter as $index => $temu_dokter)
            <tr class="align-middle">
                ...
                <td>
                    <a href="{{ $temu_dokter->status ? route('resepsionis.reservasi.update-status', $temu_dokter->idreservasi_dokter) : '#' }}">
