                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.user.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" class="form-control @error('password') is-invalid @enderror" id="password" name="confirm_password" value="{{ old('password') }}" placeholder="Masukkan konfirmasi password" required>
                            @error('password')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
