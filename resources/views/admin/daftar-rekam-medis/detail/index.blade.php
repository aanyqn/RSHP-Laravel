    ...
    <table class="table table-bordered">
        ...
        @forelse ($detailRekamMedis as $index => $detail)
            <tr class="align-middle">
                ...
                <td>{{ $detail->detail }}</td>
                <td>
                    <a href="{{ route('admin.rekam-medis.detail.edit', $detail->iddetail_rekam_medis) }}">
                    ...
                    <form id="delete-form-{{ $detail->iddetail_rekam_medis }}" action="{{ route('admin.rekam-medis.detail.delete', [$detail->iddetail_rekam_medis]) }}" method="POST" style="display: none;">
                        @csrf
                        @method('DELETE')
                    </form>
                </td>
