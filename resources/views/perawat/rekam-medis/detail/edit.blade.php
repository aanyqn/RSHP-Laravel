        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('perawat.rekam-medis.detail.update') }}" method="POST">
                        @csrf
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="{{ route('perawat.rekam-medis.detail.index', [$detail_rekam_medis[0]->idrekam_medis]) }}" class="btn btn-secondary">
