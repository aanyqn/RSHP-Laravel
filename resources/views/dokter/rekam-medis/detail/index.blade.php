...
<div class="d-flex justify-content-between m-3 mt-0">
    ...
    <form action="{{ route('dokter.rekam-medis.detail.create', $id) }}" method="GET">
        ...
        @forelse ($detailRekamMedis as $index => $detail)
            <tr class="align-middle">
                ...
                <td>
                    ...
                    <form id="delete-form-{{ $detail->iddetail_rekam_medis }}" action="{{ route('dokter.rekam-medis.detail.delete', [$detail->iddetail_rekam_medis]) }}" method="POST" style="display: none;">
                        @csrf
                        @method('DELETE')
                    </form>
                </td>
